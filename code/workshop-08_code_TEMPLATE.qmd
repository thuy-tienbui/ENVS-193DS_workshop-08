...
subtitle: "5pm Workshop"
author: "Thuy-Tien Bui"
date: "2025-05-22"
format:
  html:
...
drought_exp_clean <- drought_exp |> # INSERT COMMENT HERE
  ...
  # make a column of full drought treatment names
  mutate(water_treatment = case_match(
    water,
    "WW" ~ "Well watered",
    "DS" ~ "Drought stressed"
  )) |> 
  # making sure that species_name is a factor
  # first level should be Lotus scoparius
  mutate(species_name = as_factor(species_name),
         species_name = fct_relevel(species_name,
                                    ...
                                    "Grindelia camporum")) |> 
  # ensure water_treatment is a factor and order the levels
...
plot(model6)
plot(model7)
# all residuals look normal and no outliers
```
...
The model explained 73% (adjusted R^2^) of the variation in total mass.
